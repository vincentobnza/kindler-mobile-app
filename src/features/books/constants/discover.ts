/** Curated subject shelves shown on the Discover screen. */

export interface Shelf {
  /** Open Library subject slug used by the `/subjects/{slug}.json` endpoint. */
  subject: string
  title: string
  /** Search term the "View all" link pre-fills on the Browse screen. */
  query: string
}

export const DISCOVER_SHELVES: readonly Shelf[] = [
  { subject: "science_fiction", title: "Science fiction", query: "science fiction" },
