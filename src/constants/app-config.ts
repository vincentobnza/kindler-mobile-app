...
export const SKELETON_GRID_COUNT = 6
 ...
 * whole book as one continuous, virtualized scroll; the text is chunked into
 * sections of roughly this size so each `FlatList` row stays cheap to render
 * and only on-screen sections are mounted. The chunker never splits a paragraph.
 */
export const READER_CHARS_PER_SECTION = 1200
