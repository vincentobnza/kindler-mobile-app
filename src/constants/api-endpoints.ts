 ...
 * so those helpers return absolute URLs for use directly as image sources.
 */
...
export const API_ENDPOINTS = {
  ...
  /** Canonical Open Library web URL for a work (read / borrow online). */
  workWebUrl: (workId: string): string =>
    `${ENV.apiBaseUrl}/works/${bareId(workId)}`,
} as const
